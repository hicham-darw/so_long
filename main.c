...
int	main(int ac, char **av)
{
	...
	if (invalid_map(allvars.map, allvars.player.player_x, allvars.player.player_y))
	{
		printf("error: inavlid map\n");
		return (1);
	}
	...
	if (!put_map_to_window(&allvars, allvars.player.direction))
		return (1);
